...
return ['<a:aveng_yes:815200956059877396>', '<a:aveng_no:815200955666399303>'].includes(reaction.emoji.name) && user.id === kullanıcı.id;
};
...
await mesaj.react("<a:aveng_yes:815200956059877396>")
await mesaj.react("<a:aveng_no:815200955666399303>")
...
if (reaction.emoji.name === '<a:aveng_yes:815200956059877396>') {
